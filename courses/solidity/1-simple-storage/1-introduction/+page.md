...
To plunge into coding, we're going to be using [Remix](https://remix.ethereum.org/) (online IDE) or you can use the [Remix-Light Vscode Extension](https://marketplace.visualstudio.com/items?itemName=maxdavidwow.remix-light). You can either Google search it or access it directly from the link provided.
