...
<img src="/static/formal-verification-1/44-msg.value-check/msg_value-check1.png" width="100%" height="auto">

We then duplicate this value with `DUP1` and check if it's equal to zero with the conditional `ISZERO`

<img src="/static/formal-verification-1/44-msg.value-check/msg_value-check2.png" width="100%" height="auto">
...
<img src="/static/44-msg.value-check/msg_value-check3.png" width="100%" height="auto">
