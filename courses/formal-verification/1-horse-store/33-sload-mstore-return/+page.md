...
<img src="../static/33-sload-mstore-return/sload-mstore-return-1.png" width="100%" height="auto">
...
<img src="../static/33-sload-mstore-return/sload-mstore-return-2.png" width="100%" height="auto">
...
It's important to notes, however, that the `return` op code returns data from *memory*, not storage. As an extra step, we need to load our data into memory first.  To do this we'll be leveraging the `mstore` op code.

<img src="../static/33-sload-mstore-return/sload-mstore-return-3.png" width="100%" height="auto">
