...
::image{src='/security-section-1/11-encoding-function/encoding-function2.png' style='width: 95%; height: auto;' alt='block fee' caption='Remember the properties of a Transaction' captionSyle='font-size: 10px' figureStyle='display: flex; justify-content: center;'}
